...
Due to limitations of the Yelp API (only 50 results for each query, and only 240 results for the same query), I ran each category in batches with offsets to get the maximum results properly without overlap.
```{r, eval = FALSE}
...
There are way too many categories to work with, and the first category may not be the most relevant category. So, I won't use this.
```{r}
